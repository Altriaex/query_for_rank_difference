...
from .moe_utility_I import _log_moe_utility_tf
from .moe_utility_I import create_train_loss_op as __create_train_loss_op_I
...
def create_train_loss_op(place_holders, params, l2_reg, lr_t, step_t):
    op1_I, loss1_I, op2_I, loss2_I = __create_train_loss_op_I(place_holders, params,
                                                              l2_reg, lr_t, step_t)
    op1_II, loss1_II = _create_train_op1_II(place_holders, params, l2_reg, lr_t, _log_moe_utility_tf)
    op2_II, loss2_II = _create_train_op2_II(place_holders, params, l2_reg, lr_t, _log_moe_utility_tf)
